...
function insertAdvanceFile () { global $soshake_plugin_directory ; $page = "advanced"; require($soshake_plugin_directory."/admin/page.php"); }
function insertSoshakeMoreFile () { global $soshake_plugin_directory ; $page = "more"; require($soshake_plugin_directory."/admin/page.php"); }

function addFooterSoShake () {
...
function create_Soshake($content) {
        $layouts = array(
                "none" => array(
...
function insert_SoShake_content($content) {
        return create_Soshake($content);
}
function insert_SoShake_excerpt($content) {
        return create_Soshake($content);
}